...
#     ./scripts/vendor-local-path.sh v1.33.13+k3s2
#
# Vendored copy of k3s' packaged local-storage manifest, from
#     https://github.com/k3s-io/k3s/blob/v1.33.13+k3s2/manifests/local-storage.yaml
#
# Transformed in exactly four ways, all of them in the generator:
#   1. k3s' %-placeholders resolved (registry prefix removed, storage path = /var/lib/rancher/k3s/storage)
